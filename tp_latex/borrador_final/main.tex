...
\end{itemize}
 ...
 Luego, en las variables numéricas \textit{victima\_edad} y \textit{llamante\_edad} aparecían edades como: 125, 221, 324 que consideré errores de carga. Eliminé esos valores y dejé las celdas vacías como datos faltantes. \todo{quizás poner cuántas tenían ese problema}
