...
Primero, agrupé algunas de las restantes en tres nuevas variables por dominio, como se puede ver en el cuadro \Ref{tablaagrup} a continuación. 
...
Después, eliminé las variables cuya tasa de respuesta \texttt{SI} representaba menos del 1\% de los casos. Las variables eliminadas fueron:
\begin{multicols}{2}
\begin{itemize}
