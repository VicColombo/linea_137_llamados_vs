...
\todo{este agrupamiento vs eliminación se puede revisitar, si las cosas se ven raras o algo en el plot o o si el predictivo es muy raro o lo que sea. o se pueden hacer las dos cosas, eliminación y agrupación y ver cómo sale con cada una}

Candidatas a eliminarse si esa fuera la elección: \todo{estos puntos de corte también se pueden re evaluar o buscar biblio sobre establecer puntos de corte para variables con poca representatividad}
