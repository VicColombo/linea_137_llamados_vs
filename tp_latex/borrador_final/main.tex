...
Para el entrenamiento, separé los datos en \textit{train} y \textit{test} y separé los datos faltantes de convive (NSNS) para que sean el conjunto final de datos no vistos.
