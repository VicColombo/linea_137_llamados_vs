...
Como se puede apreciar en los gráficos de las figuras \Ref{vssino} y \Ref{ofvsino} de la sección \nameref{datos}, muchas de las variables tienen en su mayoría respuestas \textit{NO}, por lo que resultan poco informativas. Además, muchas comparten dominio semántico y jurídico, como por ejemplo:  
\begin{itemize}
...
\begin{table}[]
    \begin{tabular}{|l|c|}
    \hline
    \multicolumn{1}{|c|}{\textbf{Variable original}}        & \multicolumn{1}{l|}{\textbf{Nueva variable agrupadora}}  \\ \hline
    \textit{vs\_explotación\_sexual}                        & \multirow{4}{*}{\textit{vs\_explotación\_sexual}}        \\ \cline{1-1}
    \textit{vs\_explotación\_sexual\_comercial}             &                                                          \\ \cline{1-1}
    \textit{vs\_explotación\_sexual\_viajes\_turismo}       &                                                          \\ \cline{1-1}
    \textit{vs\_sospecha\_trata\_personas\_fines\_sexuales} &                                                          \\ \hline
    \textit{vs\_violancion\_via\_vaginal}                   & \multirow{3}{*}{\textit{vs\_violancion}}                 \\ \cline{1-1}
    \textit{vs\_violancion\_via\_anal}                      &                                                          \\ \cline{1-1}
    \textit{vs\_violancion\_via\_oral}                      &                                                          \\ \hline
    \textit{ofv\_intento\_ahogar}                           & \multirow{4}{*}{\textit{ofv\_intento\_violencia\_fatal}} \\ \cline{1-1}
    \textit{ofv\_intento\_quemar}                           &                                                          \\ \cline{1-1}
    \textit{ofv\_intento\_matar}                            &                                                          \\ \cline{1-1}
    \textit{ofv\_intento\_ahorcar}                          &                                                          \\ \hline
    \textit{ofv\_uso\_arma\_blanca}                         & \multirow{2}{*}{\textit{ofv\_uso\_arma}}                 \\ \cline{1-1}
    \textit{ofv\_uso\_arma\_fuego}                          &                                                          \\ \hline
    \end{tabular}
    \end{table}
