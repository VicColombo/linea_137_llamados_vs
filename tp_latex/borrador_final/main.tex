...
El conjunto de datos resultante de la reducción manual tiene 36 variables, 18 menos que el original (54). En el \nameref{anex} en el cuadro \ref{tab:transformaciones} se puede ver un resumen de las variables eliminadas, agrupadas, y transformadas.
...
\begin{enumerate}
    ...
    \item Realicé una búsqueda de los mejores hiperparámetros con el método gridsearch variando el tipo de kernel, el valor de C y gamma. \todo[inline]{ver a partir de acá}
