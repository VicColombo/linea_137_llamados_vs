...
\begin{table}[H]
    ...
    media               & 36.25                        & 17.17                       \\ \hline
    moda                & 40                           & 14                          \\ \hline
    desvío estándar     & 11.41                        & 11.91                       \\ \hline
    min                 & 3                            & 0                           \\ \hline
    25\%                & 29                           & 10                          \\ \hline
    50\%                & 35                           & 14                          \\ \hline
    75\%                & 42                           & 21                          \\ \hline
...
A continuación, exploré con histogramas univariados las variables \textit{victima\_genero}, \textit{victima\_convive\_agresor}, \textit{victima\_vinculo\_agresor},  y \textit{hecho\_lugar}. Además, construí la variable \textit{agresor\_conocido\_desconocido} para explorar la dicotomía extraños-conocidos en relación con las víctimas y los agresores, y la variable \textit{genero\_agresor}. Construí también las variables estación del año, fin de semana y momento del día para explorar frecuencia de los llamados. Exploré la variable provincia para ver la cantidad de llamados. 
