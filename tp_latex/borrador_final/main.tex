...
Según la distribución de la variable \textit{llamado\_provincia}, el 37\% de los llamados se realizaron en CABA; el \%36 en el resto de la provincia de Buenos Aires; del 9\% no se cuentan con datos (respuestas NS/NC); y el restante 18\% se reparte entre las restantes provincias del país, siendo de ese grupo Córdoba y Santa Fé las que más llamados tienen, con un 3\% cada una. En cuanto al lugar donde ocurrieron los casos, la distribución de la variable \textit{hecho\_lugar} indica que en aproximadamente el 30\% de los llamados no se cuenta con datos sobre el lugar de los hechos (respuestas NS/NC), pero en otro 25\% los hechos sucedieron en la vivienda de la víctima. El 13\% de los casos ocurrieron en la vivienda del agresor, y el 12\% en redes sociales. El 5\% pertenece a la categoría “otros”, y el restante 15\% se divide entre categorías de espacios públicos (plazas, descampados, etc.), transporte, y ámbito educativo, entre otros sitios.

Ignorando por el momento los datos faltantes (NS/NC), destaco la elevada proporción de casos que suceden en la vivienda de la víctima, un dato que viene a acompañar lo ya dicho en la introducción sobre los hechos de violencia sexual ocurriendo con agresores cercanos y en entornos cercanos antes que involucrar personas y lugares desconocidos. Por otro lado, me llamó la atención la cantidad de casos sucedidos en redes sociales. Al cruzar esa categoría con los tipos de violencia sufrida y las edades de las víctimas agrupadas cualitativamente en Niñez (0 a 11 años), Adolescencia (12 a 18 años), Juventud (19 a 30 años), Adultez (31 a 65 años), y Vejez (mayores de 65), observé que  



Observé según la distribución de la variable \textit{victima\_nacionalidad}\todo{reduje víctima nacionalidad para SVM?}, que el 80\% de las víctimas son argentinas; del 15\% no se cuenta con datos sobre su nacionalidad; y el restante 5\% se divide entre las nacionalidades boliviana, paraguaya, peruana, brasileña, uruguaya, y chilena, y la categoría “otra”. Según la distribución de la variable \textit{victima\_genero}, \textit{victima\_discapidad}, \textit{victima\_vinculo\_agresor}, 
