...
A continuación, medí la  correlación entre la variable objetivo \texttt{victima\_convive\_agresor} y el resto de las variables con el objetivo de inspeccionar la fuerza y dirección de las posibles correlaciones y confirmar la posibilidad de eliminar variables nada correlacionadas con encontrar correlaciones débiles y quizás reducir más el conjunto de datos.

correlación para ver si podía sacar más variables pero al final no saqué ninguna.
