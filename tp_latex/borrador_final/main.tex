...
\begin{figure}[H]
 ...
 En \textit{vinculo\_llamante\_victima}\footnote{ Ver figura \ref{vinculollamante} en el \nameref{anex}} \todo[inline]{ver si está bien hablar de distribución cada vez que voy a mostrar un barplot} \todo[inline]{describir llamante victima} \todo[inline]{considerar mencionar en cada variable cuantos niveles tienen}
