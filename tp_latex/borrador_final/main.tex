...
\todo[inline]{terminar de describir NMDS y gower}
...
Al ser NMDS un método flexible con respecto a la matriz de distancias inicial que utiliza, me permitió calcular para mis datos la distancia de Gower, una medida de similitud que puede calcularse entre datos de distinto tipo.\todo[inline]{poner fórmula de la distancia de Gower}. 
