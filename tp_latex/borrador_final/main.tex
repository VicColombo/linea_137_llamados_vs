...
A continuación, medí la  correlación entre \texttt{victima\_convive\_agresor} y el resto de las variables con el objetivo de inspeccionar la fuerza y dirección de las posibles correlaciones y considerar la posibilidad de eliminar variables nada correlacionadas.
