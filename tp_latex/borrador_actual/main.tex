...
- preprocesamiento: prepro para juntarlos + limpieza --> script pipeline
...
\todo{ver y resumir acá toda la descripción de faltantes que hay en el documento notas}



- Análisis con respecto a convive
\todo{análisis respecto a convive}
...
C. quitar las variables poco informativas xq tienen baja tasa de rta. OK script pipeline  \todo{describir}
...
- Eliminación de las variables poco informativas (menos de 191 SI) \todo{poner el porcentaje que representa ese 191}

Correlación:
- correlacion entre numerica y binaria: point biserial -> edad v, edad ll, fecha_hora contra victima convive si/no
...
Nuevamente es necesario recordar que la confiabilidad en los resultados de estos tests se ve afectada negativamente por la falta de normalidad de las variables.
...
CORRER PRIMERO EL PIPELINE PARA REDUCIR LLAMADO PROVINCIA Y LAS OTRAS ASÍ NO TENGO ESTA DESGRACIA DE CANTIDAD DE NIVELES
