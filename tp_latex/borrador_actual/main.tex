...
Correlación:
A. quiero saber más o menos cómo correlacionan las variables a convive. 

- Podría correr chi sq2 para las categóricas y pearson o algún otro para las numéricas. Sin embargo, haciendo
un test rápido veo que no puedo cumplir 1 de los requerimientos básicos de chi sq2.

- Paso todas las cat. a dummy con get dummy. \todo{pasar todas estas a dummy} y chequeo correlación con convive a ver si elimino alguna otra
...
- 4 versiones: 
- edad numérica, y 
- uso solo los datos completos de edad victima, 
- luego solo completos de edad llamante, 
- luego datos completos de ambos.
